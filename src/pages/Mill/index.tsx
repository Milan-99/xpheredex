      ...
      <TopSection gap="md">
        <DataCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Welcome to the World Swap Farm. Lock LP tokens to bake new fresh WLD Token</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  Deposit your LP tokens to receive WLD.
                 </TYPE.white>
              </RowBetween>{' '}
            </AutoColumn>
          </CardSection>
      ...
      <AutoColumn gap="lg" style={{ width: '100%', maxWidth: '720px' }}>
        <DataRow style={{ alignItems: 'baseline' }}>
          ...
          {/* <TYPE.black fontWeight={400}>
            Baguette batch #29 ends on April 30th
          </TYPE.black> */}
        </DataRow>
