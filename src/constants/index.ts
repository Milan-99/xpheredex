...
export const ANALYTICS_PAGE = 'https://etherscan.org/'
export const BRIDGE_PAGE = ''

export const ZERO_ADDRESS = '0x0000000000000000000000000000000000000000'

export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  [ChainId.FUJI]: '0xC386631E7D35c7231bE146b14cf4430b4A524F8A',
  [ChainId.AVALANCHE]: '0x201739Eca7ff1Ddfa1971CcDe6C75A4506Ded200',
...
export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AVALANCHE]: '0xb7aa6ec15BA35eEa36340fDdBFB1a47eB7F1aF1d',
...
export const ETH: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, '0x4200000000000000000000000000000000000006', 18, 'ETH', 'Ether'),
  [ChainId.CRYPTOSEALS]: new Token(ChainId.CRYPTOSEALS, ZERO_ADDRESS, 0, '', ''),
}
