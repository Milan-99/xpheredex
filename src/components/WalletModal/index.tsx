...
export default function WalletModal({
  ...
  function switchToAvalanche() {
    const AVALANCHE_MAINNET_PARAMS = {
      ...
      blockExplorerUrls: ['https://etherscan.org']
    }
