...
import LogoDark from '../../assets/svg/Logo_darkmode.svg'
...
const HeaderRow = styled(RowFixed)`
  justify-content: center; /* Center HeaderLinks horizontally */
  width: 100%;
  margin-right:20px;
...
//   display: grid;
//   grid-template-columns: 1fr 1fr 1fr; /* Change the grid layout to accommodate centered content */
//   align-items: center;
//   justify-content: center; /* Center the content within the grid */
//   flex-direction: row;
//   width: 100%;
//   top: 0;
//   position: relative;
...
const NetworkCard = styled(RedCard)`
  border-radius: 10px;
  border: 1px solid #2172E5; /* Add a border with your desired color */
  padding: 8px 12px;
  ...
  return (
    <HeaderFrame>
      ...
      <HeaderRow>
        <Title href=".">
          <BagIcon>
            <img  width={'130px'} src={LogoDark} alt="logo" />
          </BagIcon>
        </Title>
        <HeaderLinks>
        <StyledNavLink id={`deploy-nav-link`} to={'/home'}>
          ...
          <StyledExternalLink id={`bridge-external-link`} href="https://google.com" target="_blank"
  rel="noopener noreferrer">
          {t('Telegram')}
</StyledExternalLink>
<StyledExternalLink
  id={`docs-external-link`}
  href="https://x.com" // Replace with your external link
  target="_blank"
  rel="noopener noreferrer"
>
{t('X')}
        ...
        <HeaderElement>
          <HideSmall>
            {chainId && NETWORK_LABELS[chainId] && (
              <NetworkCard title={NETWORK_LABELS[chainId]}>XPhere</NetworkCard>
            )}
          </HideSmall>
          {/* {aggregateBalance && (
